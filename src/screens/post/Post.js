...
class Post extends Component {
    ...
    componentDidMount() {
        ...
        fetch(`https://graph.instagram.com/${postDataFromProps.id}?fields=id,media_type,media_url,username,timestamp&access_token=${sessionStorage.getItem('access-token')}`, {
            headers: {
            ...
            .then(json => {
                ...
                this.setState({
                    postData: {
                        ...
                        profileImageUrl: `https://graph.facebook.com/${json.username}/picture`,
                ...
                <div className='profile-modal-container openPostModalHandler'>
                    ...
                    <div className='profile-modal-details-container'>
                        ...
                        <div className='add-comment-container'>
                            ...
                            >
                                <InputLabel htmlFor={postData.id + "comment"}>Add a comment</InputLabel>
                                <Input
                                    type='text'
                                    id={postData.id + "comment"}

...
class Profile extends Component {
  ...
  componentDidMount() {
    const url = `https://graph.instagram.com/me/media?fields=id,caption, media_url&access_token=${sessionStorage.getItem('access-token')}`;
    fetch(url, {
      headers: {
      ...
      <div>
        ...
        <div className="page-container">
          <div className='profile-container'>
            <Avatar alt="Profile Picture" variant='circular' src='https://graph.facebook.com/doggocave/picture' className={classes.avatar}/>
